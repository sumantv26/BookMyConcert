...
const { getUserById, getOwnData, getMulterForAvatar, updateUserData } = require('../controllers/usersController');
const {authUsers,authManagers,authAdmin }= require('../middleware/authUsers');
